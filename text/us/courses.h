...
COURSE_ACTS(COURSE_WF, _(" 1 SNOW FIELDS"),
       _("GET THE PAGES")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_DDD, _(" 1 SNOW FIELDS"),
       _("GET THE PAGES")            , _("CHESTS IN THE CURRENT")         , _("POLE-JUMPING FOR RED COINS"),
