...
extern Vtx titleScreen_Plane_mesh_vtx_4[4];
extern Gfx titleScreen_Plane_mesh_tri_4[];
extern Vtx titleScreen_Plane_mesh_vtx_5[6];
extern Gfx titleScreen_Plane_mesh_tri_5[];
extern Vtx titleScreen_Plane_mesh_vtx_6[6];
extern Gfx titleScreen_Plane_mesh_tri_6[];
extern Vtx titleScreen_Plane_mesh_vtx_7[4];
