...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0x10, LEVEL_WF, 0x01, 0x10, WARP_CHECKPOINT),
		OBJECT(MODEL_DRAWCLOUD, -10482, 100, -27817, 0, 0, 0, 0x00070000, bhvClamShell),
		OBJECT(MODEL_NONE, -10482, 791, -27360, 0, 0, 0, 0x00100000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -22525, 141, -27817, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
