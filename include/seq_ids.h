...
enum SeqId {
    ...
    SEQ_STREAMED_STREAMED_DRAWING_THEME,
    SEQ_STREAMED_SNOW1,
    SEQ_STREAMED_VILLAGE_THEME,
    SEQ_STREAMED_SNOWY_WORLD_2,
    SEQ_STREAMED_CREATION_HALL,
    SEQ_STREAMED_OUTSIDE_HOUSE,
    SEQ_STREAMED_SURF,
    SEQ_STREAMED_RAPOSA_RESCUED,
    SEQ_STREAMED_DARK_CAVE,
    SEQ_STREAMED_LEVEL_SELECT,
    SEQ_COUNT
};
